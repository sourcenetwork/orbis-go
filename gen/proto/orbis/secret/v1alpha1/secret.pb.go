...
type Secret struct {
	...
	RingId string `protobuf:"bytes,4,opt,name=ring_id,json=ringId,proto3" json:"ring_id,omitempty"` // ring
}
...
func (x *Secret) GetRingId() string {
	if x != nil {
		return x.RingId
	}
	return ""
...
var file_orbis_secret_v1alpha1_secret_proto_rawDesc = []byte{
	...
	0x6b, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x69, 0x6e, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x06, 0x72, 0x69, 0x6e, 0x67, 0x49, 0x64, 0x22, 0x0d, 0x0a, 0x0b, 0x53, 0x65,
