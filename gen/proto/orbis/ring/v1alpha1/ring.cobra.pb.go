...
func _RingServiceCreateRingCommand(cfg *client.Config) *cobra.Command {
	...
	cmd.PersistentFlags().StringVar(&_Ring.Authentication, cfg.FlagNamer("Ring Authentication"), "", "")
	flag.WithPostSetHook(cmd.PersistentFlags(), cfg.FlagNamer("Ring Authentication"), func() { req.Ring = _Ring })
...
func _RingServiceStoreSecretCommand(cfg *client.Config) *cobra.Command {
	...
	flag.BytesBase64Var(cmd.PersistentFlags(), &_Secret.AuthzCtx, cfg.FlagNamer("Secret AuthzCtx"), "")
