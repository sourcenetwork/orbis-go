...
// randStream implements cipher.Stream, but with a deterministic output.
type randomStream rand.Rand

// NewStream returns a randStream seeded from seed, for deterministic
...
var randStream = NewStream(&testing.T{}, 0)
